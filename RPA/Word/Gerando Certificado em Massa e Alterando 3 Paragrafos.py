...
for linha in range(2, len(sheet_selecionada['A'])+1):
    ...
    for paragraph in arquivoWord.paragraphs:
        ...
        paragraph_2 = ", como carga horária de 20 horas, promovido pela escola de Cursos Online em "
        paragraphFull = f'{paragraph_1} {curso}{paragraph_2} {dia} de {mes} de {ano}'
        if "escola" in paragraph.text:
            paragraph.text = paragraphFull
            fonte = estilo.font
            fonte.name = "Calibri (Corpo)"
            fonte.size = Pt(24)
